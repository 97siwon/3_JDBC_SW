-- 도장 테이블
-- 아이디, 비밀번호, 체육관이름, 관장이름, 학생 수, 가입일, 탈퇴여부
CREATE TABLE MASTER(
...
COMMENT ON COLUMN TEST.STUDENT_BELT IS '원생 띠';
...
INSERT INTO TEST 
VALUES(SEQ_TEST_NO.NEXTVAL, '333회', '2022-10-28', '1111', '노란띠', DEFAULT, DEFAULT);

INSERT INTO TEST 
VALUES(SEQ_TEST_NO.NEXTVAL,'333회', '2022-10-28', '2222', '노란띠', DEFAULT, DEFAULT);

INSERT INTO TEST 
VALUES(SEQ_TEST_NO.NEXTVAL,'333회', '2022-10-28', '4444', '파란띠', DEFAULT, DEFAULT);

INSERT INTO TEST 
VALUES(SEQ_TEST_NO.NEXTVAL,'332회', '2022-08-28', '4444', '초록띠', DEFAULT, DEFAULT);

INSERT INTO TEST 
VALUES(SEQ_TEST_NO.NEXTVAL,'331회', '2022-06-28', '2222', '흰띠', DEFAULT, DEFAULT);

INSERT INTO TEST 
VALUES(SEQ_TEST_NO.NEXTVAL,'331회', '2022-06-28', '1111', '흰띠', DEFAULT, DEFAULT);


SELECT * FROM TEST;

-- 띠 별 원생 조회
SELECT STUDENT_NM, STUDENT_DATE, STUDENT_SECESSION_FL
FROM STUDENT
WHERE STUDENT_BELT = ?;
